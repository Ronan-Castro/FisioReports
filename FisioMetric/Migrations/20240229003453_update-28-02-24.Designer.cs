...
namespace FisioMetric.Migrations
{
    ...
    [Migration("20240229003453_update-28-02-24")]
    partial class update280224
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FisioMetric.Models.Avaliacao", b =>
                {
            ...
            modelBuilder.Entity("FisioMetric.Models.Evolucao", b =>
                {
            ...
            modelBuilder.Entity("FisioMetric.Models.Paciente", b =>
                {
            ...
            modelBuilder.Entity("FisioMetric.Models.Avaliacao", b =>
                {
                    b.HasOne("FisioMetric.Models.Paciente", "Paciente")
                        .WithMany("Avaliacoes")
                        .HasForeignKey("IdPaciente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("FisioMetric.Models.DoencasCondicoes", "DoencasCondicoes", b1 =>
                        {
                    ...
                    b.OwnsOne("FisioMetric.Models.ExameFisico", "ExameFisico", b1 =>
                        {
                            b1.Property<int>("AvaliacaoIdAvaliacao")
                                .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Cabeca", "Cabeca", b2 =>
                                {
                            ...
                            b1.OwnsOne("FisioMetric.Models.Cervical", "Cervical", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Coluna", "Coluna", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Joelhos", "Joelhos", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Ombros", "Ombros", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.PadraoMovimento", "PadraoMovimento", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Pelve", "Pelve", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("FisioMetric.Models.Pes", "Pes", b2 =>
                                {
                                    b2.Property<int>("ExameFisicoAvaliacaoIdAvaliacao")
                                        .HasColumnType("INTEGER");
                    ...
                    b.OwnsOne("FisioMetric.Models.HabitosVida", "HabitosVida", b1 =>
                        {
                            b1.Property<int>("AvaliacaoIdAvaliacao")
                                .HasColumnType("INTEGER");
